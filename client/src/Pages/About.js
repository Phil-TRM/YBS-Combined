...
const About = () => {
  ...
  return (
    ...
    >
      <p className="font-normal text-sm leading-3 text-[#7963a7] hover:text-[#452a72] cursor-pointer pb-2">
        About
      </p>
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-[#757575] mt-6">
          {data.para}
          </p>
        </div>
        <div className="w-full lg:w-6/12">
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-[#000000]">
            {data.heading5}
          </h2>
          <p className="font-normal text-base leading-6 text-[#757575] mt-6 w-full lg:w-11/12 xl:w-11/12">
            {data.para5}
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-[#757575]">
                 {data.para6}
                </p>
              </div>
            </div>
