...
import { GetMasterData, PostCategroies } from "../../utils/Const";
...
export default function AddCat2({ open, setOpen,type }) {
  ...
  const handleSubmit = (e) => {
    ...
    let data = {
      name: category,
      cateType: type==null?"Notes":type,
    };
    PostCategroies(data).then(async(d) => {
      if (d != null) {
        let data = {
          _id: Basic.uid,
