            ...
            <div className="w-full h-full bg-gray-200" style={{ fontFamily: "-apple-system, BlinkMacSystemFont,Segoe UI, Roboto,Oxygen" }}>
                <div className="flex flex-no-wrap">
                    ...
                    <div className="absolute lg:relative w-64  h-screen shadow bg-gray-100 hidden lg:block" >
                        <div onClick={() => navigate("/")} className="h-16 w-full flex  items-center px-8 cursor-pointer ">
                            <MdArrowBack className="w-5 h-5 text-black"/>
                            <img  className=" ml-2 w-28" src={Hero} alt="brand" />
                        </div>
                        <ul aria-orientation="vertical" className=" py-6">
                            {!admin ? (<>
                                <li onClick={() => navigate("/doctor/dashboard")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal pt-5 focus:text-[#452a72] focus:outline-none">
                                ...
                                <li onClick={() => navigate("/doctor/posts")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div
                                ...
                                <li onClick={() => navigate("/doctor/profile")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div className="flex items-center">
                                        <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-id-card"></i>
                                        <span className="ml-2">Profile</span>
                                    </div>
                                </li>
                                <li onClick={() => navigate("/doctor/plan")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-2 pt-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                    <div className="flex items-center">
                                ...
                                (
                                    <>
                                        ...
                                        <li onClick={() => navigate("/admin/Doctors")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div
                                        ...
                                        <li onClick={() => navigate("/admin/users")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div
                                        ...
                                        <li onClick={() => navigate("/admin/posts")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div
                                        ...
                                        <li onClick={() => navigate("/admin/profile")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-id-card"></i>
                                                <span className="ml-2">Profile</span>
                                            </div>
                                        </li>
                                        <li onClick={() => navigate("/admin/payments")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-credit-card"></i>
                                                <span className="ml-2">Payments</span>
                                            </div>
                                        </li>
                                        <li onClick={() => navigate("/admin/category")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 py-2  hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                                                <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-plus"></i>
                                                <span className="ml-2">Category</span>
                                            </div>
                                        </li>
                                        <li onClick={() => navigate("/admin/setting")} className="pl-6 cursor-pointer text-[#7963a7] text-md leading-3 tracking-normal mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                            <div className="flex items-center">
                            ...
                            <div className="flex flex-col justify-between h-full w-full">
                                <div>
                                    ...
                                    <ul aria-orientation="vertical" className=" py-6">
                                        {!admin ? (
                                            <>
                                                <li onClick={() => navigate("/doctor/dashboard")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal py-2 text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                ...
                                                <li onClick={() => navigate("/doctor/posts")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-images"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Posts</span>
                                                    </div>
                                                </li>
                                                <li onClick={() => navigate("/doctor/profile")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div>
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-id-card"></i>
                                                ...
                                                <li onClick={() => navigate("/doctor/plan")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal py-2 mb-4 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-credit-card"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Plan</span>
                                                    </div>
                                                </li>
                                            </>
                                            ...
                                            (<>
                                                ...
                                                <li onClick={() => navigate("/admin/doctors")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-user-doctor"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Doctors</span>
                                                    </div>
                                                </li>
                                                <li onClick={() => navigate("/admin/users")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-user"></i>
                                                        </div>
                                                ...
                                                <li onClick={() => navigate("/admin/posts")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-images"></i>
                                                        </div>
                                                ...
                                                <li onClick={() => navigate("/admin/profile")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-id-card"></i>
                                                        </div>
                                                ...
                                                <li onClick={() => navigate("/admin/payments")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-credit-card"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Payments</span>
                                                    </div>
                                                </li>
                                                <li onClick={() => navigate("/admin/category")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal mb-4 py-2 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-add"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Category</span>
                                                    </div>
                                                </li>
                                                <li onClick={() => navigate("/admin/setting")} className="pl-6 cursor-pointer text-[#7963a7] text-sm leading-3 tracking-normal py-2 mb-4 hover:text-[#452a72] focus:text-[#452a72] focus:outline-none">
                                                    <div className="flex items-center">
                                                        <div >
                                                            <i style={{ marginRight: "2px" }} width={20} height={20} className="fa-solid fa-gear"></i>
                                                        </div>
                                                        <span className="ml-2 xl:text-base md:text-2xl text-base">Settings</span>
                                                    </div>
                                                </li>
                                            </>)
                                        }
                                ...
                                <div className="w-full">
                                    ...
                                    <div className="border-t border-gray-300">
                                        <div className="w-full flex items-center justify-between px-6 pt-1">
                                            <div className="flex items-center">
                                                <img alt="profile-pic" src={FILE_URL+userData.dp}className="w-8 h-8 rounded-md" />
                                                <p className="md:text-xl text-gray-800 text-base leading-4 ml-2">{userData.name}</p>
                                            </div>
                                            <ul className="flex">
                                        ...
                                        <div className="flex items-center relative cursor-pointer" onClick={() => setProfile(!profile)}>
                                            <div className="rounded-full">
                                                {profile ? (
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        <li className="flex w-full justify-between text-[#7963a7] hover:text-[#452a72] cursor-pointer items-center">
                                                            <div onClick={() => navigate("/doctor/profile")} className="flex items-center">
                                                        ...
                                                        <li className="flex w-full justify-between text-[#7963a7] hover:text-[#452a72] cursor-pointer items-center mt-2" onClick={()=>{handleLogOut()}}>
                                                            <div className="flex items-center">
                                                ...
                                                <div className="relative">
                                                    <img className="rounded-full h-10 w-10 object-cover" src={FILE_URL+userData.dp} alt="avatar" />
                                                    <div className="w-2 h-2 rounded-full bg-green-400 border border-white absolute inset-0 mb-0 mr-0 m-auto" />
                                                </div>
                                            </div>
                                            <p className="text-gray-800 text-sm mx-3">{userData.name}</p>
